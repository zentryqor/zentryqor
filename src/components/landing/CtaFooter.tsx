        ...
        <div className="relative">
          ...
          <div className="mt-8 flex items-center justify-center gap-3 flex-wrap">
            <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.96 }} transition={{ type: "spring", stiffness: 400, damping: 20 }}>
              <Link to="/auth" className="group inline-flex items-center gap-2 h-12 px-5 rounded-xl bg-foreground text-background text-sm font-medium magnetic glow-primary">
                Start free
                <ArrowUpRight className="h-4 w-4 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
              </Link>
            </motion.div>
            <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.96 }} transition={{ type: "spring", stiffness: 400, damping: 20 }}>
              <a href="#pricing" className="h-12 px-5 rounded-xl glass text-sm font-medium magnetic flex items-center">
                View pricing
              </a>
            </motion.div>
          </div>
